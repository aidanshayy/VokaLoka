...
const styles = {
  wrapper: {
    height: '50vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fbeaff, #d9e7ff)', textAlign: 'center' as const
  },
